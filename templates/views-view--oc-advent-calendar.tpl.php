      ...
      <div class="advent-calendar-modal-body-text"></div>
            <div class="advent-calendar-modal-contact-form" >
                <form style="display:none">
                    ...
                    <a class="btn advent-calendar-modal-submit-contact-form" style="width:91%;background-color: #0b7787;color: white;cursor:pointer">Send</a>
                </form>
            </div>
            <div class="advent-calendar-modal-contact-form-msg" style="display:none"></div>
      </div>
      <div class="modal-footer">
        <button type="button" style="background-color:#0b7787;cursor:pointer" class="btn btn-secondary advendt-calendar-close-button" data-dismiss="modal">Luk</button>
      </div>
    </div>
  </div>
</div>